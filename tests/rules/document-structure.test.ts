...
describe('document-structure rule', () => {
  ...
  it('violation message describes the accessibility defect, not a cause', () => {
    ...
    // Guard: qualm reports defects, it does not attribute them. A rule message
    // may say what is wrong with the code and how to fix it, never who or what
    // wrote it. See METHODOLOGY.md.
